...
B1DetectorConstruction_steps::B1DetectorConstruction_steps()
...
G4VPhysicalVolume* B1DetectorConstruction_steps::Construct()
{  
  ...
  double r = rmin;
  G4double can_pDz = 6.*cm; // height of cans on inner rings
