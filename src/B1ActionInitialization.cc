...
B1ActionInitialization::B1ActionInitialization(int argc, char** argv)
...
{
  B1AnalysisManager* ana = new B1AnalysisManager(fargc, fargv);
  ...
  SetUserAction(new B1SteppingAction(eventAction, ana));
}  
